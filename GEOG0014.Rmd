...
- Untick the boxes of the `roads` and `2021-11-metropolitan-street` layers to deactivate them.
- Select the `boroughs` layer by clicking on it.
- Click on the **Select Features by Area or Single Click** button: <img src='images/w08/select.png'>
