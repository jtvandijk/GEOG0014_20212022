...
Before doing anything else, now would be a good time to save our QGIS project. Go to \textbf{File} \textgreater{} \textbf{Save as} and save your file in your \emph{working directory} as \texttt{crime\_map}.
