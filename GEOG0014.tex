...
After downloading both files, go to your \texttt{Downloads} folder and make sure both are uncompressed. Your \texttt{Downloads} folder should look something like this:
...
\addcontentsline{toc}{subsubsection}{Analysing macro patterns}
